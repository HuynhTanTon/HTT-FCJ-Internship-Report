...
5. CloudWatch Alarm `url-shortener-error-alarm`, metric filter, log group `/aws/lambda/url-shortener-backend` (nếu không còn cần).
6. SNS topic / subscription email dùng cho alarm.
