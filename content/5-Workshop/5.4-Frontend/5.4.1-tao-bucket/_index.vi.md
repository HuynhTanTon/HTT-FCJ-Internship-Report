...
Mình tạo bucket **`url-shortener-frontend-forward`** tại **Asia Pacific (Singapore) `ap-southeast-1`**, sau đó bật **Static website hosting** kiểu Bucket hosting với document mặc định `index.html`.

Website endpoint dùng để truy cập UI:
