...
| 6 | Cài đặt AWS CLI trên máy cá nhân, cấu hình Access Key và kiểm tra kết nối API. | 24/04/2026 | 24/04/2026 | <https://000011.awsstudygroup.com/> |
...
* Ban đầu lúng túng với giao diện Console vì có quá nhiều dịch vụ → tập trung theo lộ trình [Cloud Journey](https://cloudjourney.awsstudygroup.com/) và dùng thanh tìm kiếm để tra cứu dịch vụ nhanh.

### Kế hoạch tuần tiếp theo:

* Tìm hiểu AWS IAM — quản lý người dùng, phân quyền và bảo mật tài khoản AWS.
